...
<main class="lc-about-main">
	...
	上記はあくまで宅地建物取引業法に基づく上限額です。実際のご契約時はその都度お見積りいたします。賃貸物件の仲介手数料は別途、契約形態に応じてご案内します。
		...
		<div class="lc-fee-tokurei">
			...
			<p class="lc-fee-tokurei__lead">
				この特例を適用する場合は、媒介契約の締結前に金額を明示してご説明し、ご了承をいただいた上で契約を締結いたします。
			</p>
	...
	<section class="lc-about-section" id="ceo">
		...
		<div class="lc-profile">
			...
			<div class="lc-profile__body">
				...
				ホームページをご覧いただき、ありがとうございます。稚内で賃貸物件のご紹介とアパート管理に携わり、30年になります。長く続けてこられたのは、経験だけでなく、親切丁寧に、わかりやすくお伝えすることを心がけてきたからかもしれません。30年やってきて思うのは、「おすすめしないこともお伝えする」ことが大事だ、ということです。分かりにくいことは、何度でもご説明いたします。良いところも気になるところも両方お話ししたうえで、お客様ご自身に選んでいただく。それが結局、長くお付き合いいただける道だと考えています。どうぞお気軽にご相談ください。	
